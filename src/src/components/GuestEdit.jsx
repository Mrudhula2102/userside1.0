...
const GuestEdit = (props) => {
  ...
  return (
    ...
    <div className='div'>
      ...
      <TextField  label="ID" variant="filled" name="gid" value={guestuser.gid} onChange={guestuserhandler}/><br/><br/>
      ...
      Status: &nbsp;&nbsp;
      <select name="gstatus" value={guestuser.gstatus}  onChange={guestuserhandler}>
